...
public class NeuroskyMessage {
	...
	public NeuroskyMessage() {
		
	}
	
	public NeuroskyMessage(int msgId, byte[] payload, byte end) {
		this.msgId = msgId;
		this.setPayload(payload);
		this.end = end;
	}
	
	public static NeuroskyMessage parse(byte[] stream) {
		int streamIndex = 0;
		NeuroskyMessage m = new NeuroskyMessage();
