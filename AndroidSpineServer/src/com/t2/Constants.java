...
public class Constants {
	...
	public static int DATA_TYPE_HEARTRATE = 1;
	public static int DATA_TYPE_MEDITATION = 2;
	public static int DATA_TYPE_ATTENTION = 3;
	public static int DATA_SIGNAL_STRENGTH = 4;	
